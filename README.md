Привет, меня зовут Адамей
==============================================================================================================================

Начинающий эксперт в аналитике и DS
-----------------------------------

Учусь на 3 курсе образовательной программы "Прикладной анализ данных" НИУ ВШЭ.

Изучил выш.мат, Python, C++, алгоритмы и структуры данных в рамках университетских дисциплин и дополнительного образования(курсы, учебники, т.д.).Владею навыками в обработке и анализе данных с помощью pandas, SQL, Excel, numpy. 
